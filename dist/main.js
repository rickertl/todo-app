...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "/* base color is powderblue, hex #B0E0E6 */\n* {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box; }\n\nbody {\n  font-family: \"Inter\", sans-serif;\n  background-color: powderblue; }\n\nbutton {\n  height: 35px;\n  font-size: 1rem;\n  font-family: \"Inter\", sans-serif;\n  font-weight: 400;\n  padding: 5px 10px;\n  background-color: #efefef;\n  border: 1px solid #767676;\n  border-radius: 2.5px;\n  color: black;\n  cursor: pointer; }\n\nform:not(#select-project) {\n  display: flex;\n  flex-direction: column; }\n\nform input,\nform select,\nform textarea {\n  margin-bottom: 15px;\n  padding: 4px 10px;\n  font-size: 1rem;\n  font-family: \"Inter\", sans-serif;\n  color: black;\n  border: 1px solid #767676;\n  border-radius: 2px;\n  background-color: white; }\n\nform label {\n  font-weight: 600;\n  margin-bottom: 8px; }\n\nmain {\n  height: 100vh;\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: center;\n  align-content: flex-start;\n  column-gap: 25px; }\n\n.column1 {\n  min-width: 170px;\n  background-color: powderblue;\n  padding: 15px 0;\n  display: flex;\n  align-items: flex-start; }\n  @media screen and (min-width: 600px) {\n    .column1 {\n      justify-content: flex-end; } }\n  .column1 .logo {\n    display: flex;\n    align-items: center;\n    justify-content: center; }\n    .column1 .logo svg {\n      width: 70px; }\n    .column1 .logo .logo-text {\n      font-size: 2.5rem;\n      font-weight: 600; }\n\n.column2 {\n  height: 100%;\n  width: 100%;\n  background-color: white;\n  position: relative; }\n  @media screen and (min-width: 600px) {\n    .column2 {\n      width: auto; } }\n  .column2 .tasks {\n    padding: 20px 10px; }\n    @media screen and (min-width: 600px) {\n      .column2 .tasks {\n        width: 585px;\n        padding: 30px; } }\n    .column2 .tasks .tasks-header {\n      display: grid;\n      grid-template-columns: repeat(auto-fit, minmax(255px, 1fr));\n      grid-column-gap: 15px;\n      grid-row-gap: 15px;\n      margin-bottom: 20px; }\n      .column2 .tasks .tasks-header .hdr-col1 #select-project select {\n        width: 100%; }\n      .column2 .tasks .tasks-header .hdr-col1 form select {\n        margin-bottom: 0; }\n      .column2 .tasks .tasks-header .hdr-col2 {\n        display: grid;\n        grid-template-columns: 1fr 1fr;\n        align-items: center; }\n        .column2 .tasks .tasks-header .hdr-col2 a {\n          color: black; }\n        .column2 .tasks .tasks-header .hdr-col2 .list-actions {\n          display: grid;\n          grid-template-columns: auto auto;\n          justify-content: start;\n          grid-gap: 15px; }\n        .column2 .tasks .tasks-header .hdr-col2 .add-task {\n          justify-self: end;\n          font-weight: 600; }\n    .column2 .tasks .task-container {\n      display: grid;\n      grid-template-columns: auto 1fr auto;\n      align-items: center;\n      grid-gap: 2px 10px;\n      background-color: rgba(176, 224, 230, 0.15);\n      border: 1px solid powderblue;\n      padding: 6px;\n      margin-bottom: 10px;\n      border-radius: 2.5px; }\n      @media screen and (min-width: 800px) {\n        .column2 .tasks .task-container {\n          grid-template-columns: auto minmax(0, 1fr) auto auto; } }\n      .column2 .tasks .task-container div {\n        display: flex;\n        align-items: center; }\n      .column2 .tasks .task-container input.task-checkbox {\n        width: 24px;\n        height: 24px;\n        border: 1px solid #767676;\n        order: -1; }\n      .column2 .tasks .task-container .task-title {\n        grid-column: span 2; }\n        @media screen and (min-width: 800px) {\n          .column2 .tasks .task-container .task-title {\n            grid-column: span 1; } }\n        .column2 .tasks .task-container .task-title span {\n          overflow: hidden;\n          white-space: nowrap;\n          text-overflow: ellipsis; }\n        .column2 .tasks .task-container .task-title.complete {\n          text-decoration: line-through; }\n      .column2 .tasks .task-container .task-due-date {\n        grid-column: span 2; }\n        @media screen and (min-width: 800px) {\n          .column2 .tasks .task-container .task-due-date {\n            grid-column: span 1; } }\n      .column2 .tasks .task-container .task-due-date,\n      .column2 .tasks .task-container .task-priority {\n        font-size: 0.85rem; }\n      .column2 .tasks .task-container .task-priority {\n        background-color: white;\n        border: 1px solid #767676;\n        border-radius: 2px;\n        padding: 2px 0;\n        box-shadow: none !important;\n        color: black; }\n        .column2 .tasks .task-container .task-priority.high {\n          background-color: #e99979; }\n        .column2 .tasks .task-container .task-priority.low {\n          background-color: powderblue; }\n      .column2 .tasks .task-container.complete,\n      .column2 .tasks .task-container.complete > .task-priority {\n        background-color: #efefef;\n        color: #767676; }\n      .column2 .tasks .task-container .more {\n        grid-column: span 3;\n        display: none; }\n        @media screen and (min-width: 800px) {\n          .column2 .tasks .task-container .more {\n            grid-column: span 4; } }\n      .column2 .tasks .task-container .show-more {\n        display: block; }\n        .column2 .tasks .task-container .show-more .task-description {\n          display: grid;\n          margin: 5px 0 0;\n          padding-top: 10px;\n          border-top: 1px dotted powderblue; }\n          .column2 .tasks .task-container .show-more .task-description::before {\n            content: \"Description:\";\n            font-weight: 600;\n            margin-bottom: 5px; }\n        .column2 .tasks .task-container .show-more .task-buttons {\n          display: grid;\n          grid-template-columns: 1fr 1fr;\n          grid-gap: 20px;\n          margin-top: 15px; }\n  .column2 .task-entry,\n  .column2 .project-entry {\n    display: none; }\n    .column2 .task-entry.overlay,\n    .column2 .project-entry.overlay {\n      position: absolute;\n      top: 0;\n      height: 100%;\n      width: 100%;\n      background-color: rgba(0, 0, 0, 0.8);\n      padding: 30px;\n      display: flex;\n      align-items: flex-start;\n      justify-content: center; }\n    .column2 .task-entry form,\n    .column2 .project-entry form {\n      max-width: 320px;\n      background-color: white;\n      padding: 30px;\n      border-radius: 2.5px;\n      position: relative; }\n      .column2 .task-entry form#task-entry textarea,\n      .column2 .project-entry form#task-entry textarea {\n        height: 100px;\n        resize: vertical; }\n      .column2 .task-entry form#task-entry button,\n      .column2 .project-entry form#task-entry button {\n        margin-top: 10px; }\n      .column2 .task-entry form .close-btn,\n      .column2 .project-entry form .close-btn {\n        position: absolute;\n        top: 10px;\n        right: 10px;\n        cursor: pointer; }\n  .column2 .project-entry .container {\n    display: none; }\n  .column2 .project-entry.editing {\n    display: grid;\n    grid-gap: 30px;\n    align-content: start; }\n    .column2 .project-entry.editing .container {\n      display: grid;\n      grid-gap: 30px;\n      background-color: white;\n      padding: 30px; }\n      .column2 .project-entry.editing .container a {\n        text-align: center;\n        text-decoration: underline; }\n", "",{"version":3,"sources":["webpack://./src/style.scss"],"names":[],"mappings":"AAEA,0CAAA;AAQA;EACE,SAAS;EACT,UAAU;EACV,sBAAsB,EAAA;;AAExB;EACE,gCAT+B;EAU/B,4BAA4B,EAAA;;AAE9B;EACE,YAAY;EACZ,eAAe;EACf,gCAf+B;EAgB/B,gBAAgB;EAChB,iBAAiB;EACjB,yBApBkB;EAqBlB,yBAtBiB;EAuBjB,oBAAoB;EACpB,YAAY;EACZ,eAAe,EAAA;;AAEjB;EACE,aAAa;EACb,sBAAsB,EAAA;;AAExB;;;EAGE,mBAAmB;EACnB,iBAAiB;EACjB,eAAe;EACf,gCAlC+B;EAmC/B,YAAY;EACZ,yBAvCiB;EAwCjB,kBAAkB;EAClB,uBAAuB,EAAA;;AAEzB;EACE,gBAAgB;EAChB,kBAAkB,EAAA;;AAEpB;EACE,aAAa;EACb,aAAa;EACb,eAAe;EACf,uBAAuB;EACvB,yBAAyB;EACzB,gBAAgB,EAAA;;AAElB;EACE,gBAA4B;EAC5B,4BAA4B;EAC5B,eAAe;EACf,aAAa;EACb,uBAAuB,EAAA;EACvB;IANF;MAOI,yBAAyB,EAAA,EAc5B;EArBD;IAUI,aAAa;IACb,mBAAmB;IACnB,uBAAuB,EAAA;IAZ3B;MAcM,WAAW,EAAA;IAdjB;MAiBM,iBAAiB;MACjB,gBAAgB,EAAA;;AAItB;EAEE,YAAY;EACZ,WAAW;EACX,uBAAuB;EACvB,kBAAkB,EAAA;EAClB;IANF;MAOI,WAAW,EAAA,EAsMd;EA7MD;IAUI,kBAAkB,EAAA;IAClB;MAXJ;QAYM,YAAkC;QAClC,aAAa,EAAA,EAsIhB;IAnJH;MAgBM,aAAa;MACb,2DAGC;MACD,qBAAqB;MACrB,kBAAkB;MAClB,mBAAmB,EAAA;MAvBzB;QA2BY,WAAW,EAAA;MA3BvB;QA+BU,gBAAgB,EAAA;MA/B1B;QAmCQ,aAAa;QACb,8BAA8B;QAC9B,mBAAmB,EAAA;QArC3B;UAuCU,YAAY,EAAA;QAvCtB;UA0CU,aAAa;UACb,gCAAgC;UAChC,sBAAsB;UACtB,cAAc,EAAA;QA7CxB;UAgDU,iBAAiB;UACjB,gBAAgB,EAAA;IAjD1B;MAsDM,aAAa;MACb,oCAAoC;MAIpC,mBAAmB;MACnB,kBAAkB;MAClB,2CAA2C;MAC3C,4BAA4B;MAC5B,YAAY;MACZ,mBAAmB;MACnB,oBAAoB,EAAA;MATpB;QAxDN;UAyDQ,oDAAoD,EAAA,EAyFvD;MAlJL;QAmEQ,aAAa;QACb,mBAAmB,EAAA;MApE3B;QAuEQ,WAAW;QACX,YAAY;QACZ,yBAtJW;QAuJX,SAAS,EAAA;MA1EjB;QA6EQ,mBAAmB,EAAA;QACnB;UA9ER;YA+EU,mBAAmB,EAAA,EAUtB;QAzFP;UAkFU,gBAAgB;UAChB,mBAAmB;UACnB,uBAAuB,EAAA;QApFjC;UAuFU,6BAA6B,EAAA;MAvFvC;QA2FQ,mBAAmB,EAAA;QACnB;UA5FR;YA6FU,mBAAmB,EAAA,EAEtB;MA/FP;;QAkGQ,kBAAkB,EAAA;MAlG1B;QAqGQ,uBAAuB;QACvB,yBAnLW;QAoLX,kBAAkB;QAClB,cAAc;QACd,2BAA2B;QAC3B,YAAY,EAAA;QA1GpB;UA4GU,yBAvLG,EAAA;QA2Eb;UA+GU,4BAA4B,EAAA;MA/GtC;;QAoHQ,yBAhMY;QAiMZ,cAlMW,EAAA;MA6EnB;QAwHQ,mBAAmB;QACnB,aAAa,EAAA;QACb;UA1HR;YA2HU,mBAAmB,EAAA,EAEtB;MA7HP;QA+HQ,cAAc,EAAA;QA/HtB;UAiIU,aAAa;UACb,eAAe;UACf,iBAAiB;UACjB,iCAAiC,EAAA;UApI3C;YAsIY,uBAAuB;YACvB,gBAAgB;YAChB,kBAAkB,EAAA;QAxI9B;UA4IU,aAAa;UACb,8BAA8B;UAC9B,cAAc;UACd,gBAAgB,EAAA;EA/I1B;;IAsJI,aAAa,EAAA;IAtJjB;;MAwJM,kBAAkB;MAClB,MAAM;MACN,YAAY;MACZ,WAAW;MACX,oCAAsC;MACtC,aAAa;MACb,aAAa;MACb,uBAAuB;MACvB,uBAAuB,EAAA;IAhK7B;;MAmKM,gBAAgB;MAChB,uBAAuB;MACvB,aAAa;MACb,oBAAoB;MACpB,kBAAkB,EAAA;MAvKxB;;QA0KU,aAAa;QACb,gBAAgB,EAAA;MA3K1B;;QA8KU,gBAAgB,EAAA;MA9K1B;;QAkLQ,kBAAkB;QAClB,SAAS;QACT,WAAW;QACX,eAAe,EAAA;EArLvB;IA2LM,aAAa,EAAA;EA3LnB;IA8LM,aAAa;IACb,cAAc;IACd,oBAAoB,EAAA;IAhM1B;MAkMQ,aAAa;MACb,cAAc;MACd,uBAAuB;MACvB,aAAa,EAAA;MArMrB;QAuMU,kBAAkB;QAClB,0BAA0B,EAAA","sourcesContent":["@import url(\"https://fonts.googleapis.com/css2?family=Inter:wght@400;600&display=swap\");\n\n/* base color is powderblue, hex #B0E0E6 */\n$light-powderblue: rgba(176, 224, 230, 0.15);\n$dark-gray: #767676;\n$light-gray: #efefef;\n$red: #e99979;\n$global-font: \"Inter\", sans-serif;\n$col1-width: 170;\n\n* {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n}\nbody {\n  font-family: $global-font;\n  background-color: powderblue;\n}\nbutton {\n  height: 35px;\n  font-size: 1rem;\n  font-family: $global-font;\n  font-weight: 400;\n  padding: 5px 10px;\n  background-color: $light-gray;\n  border: 1px solid $dark-gray;\n  border-radius: 2.5px;\n  color: black;\n  cursor: pointer;\n}\nform:not(#select-project) {\n  display: flex;\n  flex-direction: column;\n}\nform input,\nform select,\nform textarea {\n  margin-bottom: 15px;\n  padding: 4px 10px;\n  font-size: 1rem;\n  font-family: $global-font;\n  color: black;\n  border: 1px solid $dark-gray;\n  border-radius: 2px;\n  background-color: white;\n}\nform label {\n  font-weight: 600;\n  margin-bottom: 8px;\n}\nmain {\n  height: 100vh;\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: center;\n  align-content: flex-start;\n  column-gap: 25px;\n}\n.column1 {\n  min-width: $col1-width * 1px;\n  background-color: powderblue;\n  padding: 15px 0;\n  display: flex;\n  align-items: flex-start;\n  @media screen and (min-width: 600px) {\n    justify-content: flex-end;\n  }\n  .logo {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    svg {\n      width: 70px;\n    }\n    .logo-text {\n      font-size: 2.5rem;\n      font-weight: 600;\n    }\n  }\n}\n.column2 {\n  // align-self: stretch;\n  height: 100%;\n  width: 100%;\n  background-color: white;\n  position: relative;\n  @media screen and (min-width: 600px) {\n    width: auto;\n  }\n  .tasks {\n    padding: 20px 10px;\n    @media screen and (min-width: 600px) {\n      width: 3px * $col1-width + 15 + 60;\n      padding: 30px;\n    }\n    .tasks-header {\n      display: grid;\n      grid-template-columns: repeat(\n        auto-fit,\n        minmax(3px * $col1-width / 2, 1fr)\n      );\n      grid-column-gap: 15px;\n      grid-row-gap: 15px;\n      margin-bottom: 20px;\n      .hdr-col1 {\n        #select-project {\n          select {\n            width: 100%;\n          }\n        }\n        form select {\n          margin-bottom: 0;\n        }\n      }\n      .hdr-col2 {\n        display: grid;\n        grid-template-columns: 1fr 1fr;\n        align-items: center;\n        a {\n          color: black;\n        }\n        .list-actions {\n          display: grid;\n          grid-template-columns: auto auto;\n          justify-content: start;\n          grid-gap: 15px;\n        }\n        .add-task {\n          justify-self: end;\n          font-weight: 600;\n        }\n      }\n    }\n    .task-container {\n      display: grid;\n      grid-template-columns: auto 1fr auto;\n      @media screen and (min-width: 800px) {\n        grid-template-columns: auto minmax(0, 1fr) auto auto;\n      }\n      align-items: center;\n      grid-gap: 2px 10px;\n      background-color: rgba(176, 224, 230, 0.15);\n      border: 1px solid powderblue;\n      padding: 6px;\n      margin-bottom: 10px;\n      border-radius: 2.5px;\n      div {\n        display: flex;\n        align-items: center;\n      }\n      input.task-checkbox {\n        width: 24px;\n        height: 24px;\n        border: 1px solid $dark-gray;\n        order: -1;\n      }\n      .task-title {\n        grid-column: span 2;\n        @media screen and (min-width: 800px) {\n          grid-column: span 1;\n        }\n        span {\n          overflow: hidden;\n          white-space: nowrap;\n          text-overflow: ellipsis;\n        }\n        &.complete {\n          text-decoration: line-through;\n        }\n      }\n      .task-due-date {\n        grid-column: span 2;\n        @media screen and (min-width: 800px) {\n          grid-column: span 1;\n        }\n      }\n      .task-due-date,\n      .task-priority {\n        font-size: 0.85rem;\n      }\n      .task-priority {\n        background-color: white;\n        border: 1px solid $dark-gray;\n        border-radius: 2px;\n        padding: 2px 0;\n        box-shadow: none !important;\n        color: black;\n        &.high {\n          background-color: $red;\n        }\n        &.low {\n          background-color: powderblue;\n        }\n      }\n      &.complete,\n      &.complete > .task-priority {\n        background-color: $light-gray;\n        color: $dark-gray;\n      }\n      .more {\n        grid-column: span 3;\n        display: none;\n        @media screen and (min-width: 800px) {\n          grid-column: span 4;\n        }\n      }\n      .show-more {\n        display: block;\n        .task-description {\n          display: grid;\n          margin: 5px 0 0;\n          padding-top: 10px;\n          border-top: 1px dotted powderblue;\n          &::before {\n            content: \"Description:\";\n            font-weight: 600;\n            margin-bottom: 5px;\n          }\n        }\n        .task-buttons {\n          display: grid;\n          grid-template-columns: 1fr 1fr;\n          grid-gap: 20px;\n          margin-top: 15px;\n        }\n      }\n    }\n  }\n  .task-entry,\n  .project-entry {\n    display: none;\n    &.overlay {\n      position: absolute;\n      top: 0;\n      height: 100%;\n      width: 100%;\n      background-color: rgba($color: #000000, $alpha: 0.8);\n      padding: 30px;\n      display: flex;\n      align-items: flex-start;\n      justify-content: center;\n    }\n    form {\n      max-width: 320px;\n      background-color: white;\n      padding: 30px;\n      border-radius: 2.5px;\n      position: relative;\n      &#task-entry {\n        textarea {\n          height: 100px;\n          resize: vertical;\n        }\n        button {\n          margin-top: 10px;\n        }\n      }\n      .close-btn {\n        position: absolute;\n        top: 10px;\n        right: 10px;\n        cursor: pointer;\n      }\n    }\n  }\n  .project-entry {\n    .container {\n      display: none;\n    }\n    &.editing {\n      display: grid;\n      grid-gap: 30px;\n      align-content: start;\n      .container {\n        display: grid;\n        grid-gap: 30px;\n        background-color: white;\n        padding: 30px;\n        a {\n          text-align: center;\n          text-decoration: underline;\n        }\n      }\n    }\n  }\n}\n"],"sourceRoot":""}]);
// Exports
...
if (localStorage.getItem("localProjects")) {
  ...
  storedProjects.forEach((project) => {
    ...
    const newProject = new _project_js__WEBPACK_IMPORTED_MODULE_0__.Project(project.title, project.selected);
...
const readyForProjects = (function () {
  ...
  main.querySelector(".edit-list > a").addEventListener("click", (event) => {
    ...
    projectEntryForm.querySelector("#title").value = _project_js__WEBPACK_IMPORTED_MODULE_0__.project.title;
  ...
  projectEntryForm.addEventListener("submit", (event) => {
    ...
    if (projectEntryForm.getAttribute("action") === "add") {
      ...
      _data_js__WEBPACK_IMPORTED_MODULE_1__.projects.push(
        new _project_js__WEBPACK_IMPORTED_MODULE_0__.Project(projectEntryForm.elements["title"].value, true)
      );
    } else if (projectEntryForm.getAttribute("action") === "edit") {
      _project_js__WEBPACK_IMPORTED_MODULE_0__.project.editProject(projectEntryForm.elements["title"].value);
    }
    resetProjectEntry();
    buildProjectView();
  });
