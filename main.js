...
const listenForProjectFormRequests = (function () {
  ...
  projectEntryForm.addEventListener("submit", (event) => {
    ...
    if (projectEntryForm.getAttribute("action") === "add") {
      ...
      _controller_js__WEBPACK_IMPORTED_MODULE_2__.project.title = projectEntryForm.elements["title"].value;
  ...
  deleteCompletedTasksBtn.addEventListener("click", (event) => {
    event.preventDefault();
    for (let index = _controller_js__WEBPACK_IMPORTED_MODULE_2__.project.tasks.length - 1; index > -1; index--) {
      if (_controller_js__WEBPACK_IMPORTED_MODULE_2__.project.tasks[index].complete) {
...
const buildProjectView = function (projects) {
  ...
  editProjectLink.setAttribute("data-id", _controller_js__WEBPACK_IMPORTED_MODULE_2__.projectID);
