...
function findSelectedProject() {
  _data_js__WEBPACK_IMPORTED_MODULE_0__.projects.forEach((item, index) => {
...
if (localStorage.getItem("localProjects")) {
  ...
  storedProjects.forEach((project) => {
    ...
    const newProject = new _project_js__WEBPACK_IMPORTED_MODULE_0__["default"](project.title, project.selected);
  ...
  const defaultProject = new _project_js__WEBPACK_IMPORTED_MODULE_0__["default"]("Tasks", true);
...
const buildProjectView = function () {
  (0,_controller_js__WEBPACK_IMPORTED_MODULE_2__.findSelectedProject)();
...
const displayTaskDueDate = function (task, taskContainer) {
  ...
  if (task.dueDate) {
    taskDueDate.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(
...
const displayTaskDelete = function (index, taskButtons) {
  ...
  taskDeleteBtn.addEventListener("click", (event) => {
    event.preventDefault();
    event.stopPropagation();
    _controller_js__WEBPACK_IMPORTED_MODULE_2__.project.deleteTask(taskDeleteBtn.getAttribute("data-id"), true);
  });
};
...
const readyForProjects = (function () {
  ...
  main.querySelector(".edit-list > a").addEventListener("click", (event) => {
    ...
    projectEntryForm.querySelector("#title").value = _controller_js__WEBPACK_IMPORTED_MODULE_2__.project.title;
  ...
  projectEntryForm.addEventListener("submit", (event) => {
    ...
    if (projectEntryForm.getAttribute("action") === "add") {
      ...
      _data_js__WEBPACK_IMPORTED_MODULE_1__.projects.push(
        new _project_js__WEBPACK_IMPORTED_MODULE_0__["default"](projectEntryForm.elements["title"].value, true)
      );
    } else if (projectEntryForm.getAttribute("action") === "edit") {
      _controller_js__WEBPACK_IMPORTED_MODULE_2__.project.editProject(projectEntryForm.elements["title"].value);
    }
    resetProjectEntry();
    buildProjectView(_data_js__WEBPACK_IMPORTED_MODULE_1__.projects);
  });
  ...
  projectEntry
    ...
    .addEventListener("click", (event) => {
      event.preventDefault();
      _controller_js__WEBPACK_IMPORTED_MODULE_2__.project.deleteTasks("completed", false);
      resetProjectEntry();
    });
  ...
  projectEntry
    ...
    .addEventListener("click", (event) => {
      event.preventDefault();
      _controller_js__WEBPACK_IMPORTED_MODULE_2__.project.deleteTasks("all", false);
      resetProjectEntry();
    });
  ...
  projectEntry
    ...
    .addEventListener("click", (event) => {
      event.preventDefault();
      _controller_js__WEBPACK_IMPORTED_MODULE_2__.project.deleteProject(_controller_js__WEBPACK_IMPORTED_MODULE_2__.projectID);
      resetProjectEntry();
      buildProjectView(_data_js__WEBPACK_IMPORTED_MODULE_1__.projects);
    });
  // close button
...
const selectProject = (function () {
  selectProjectSelector.addEventListener("change", (event) => {
    ...
    _controller_js__WEBPACK_IMPORTED_MODULE_2__.project.switchSelectedProject(index);
    buildProjectView(_data_js__WEBPACK_IMPORTED_MODULE_1__.projects);
  });
})();
